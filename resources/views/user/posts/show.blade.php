            ...
            <div class="container px-5 py-24 mx-auto">
              ...
              <div class="lg:w-1/2 md:w-3/4 mx-auto">
                <div class="-m-2">
                  ...
                  <div class="p-2 w-full mt-4 flex flex-col lg:justify-around sm:flex-row justify-around">
                    ...
                    <div class="flex justify-around mb-2 sm:mb-0">
                      <form method="get" action="{{ route('user.posts.edit', ['post' => $post->id ]) }}" class="lg:mr-5 md:mr-5">
                      ...
                      <form id="delete_{{ $post->id }}" method="post" action="{{ route('user.posts.destroy', ['post' => $post->id ]) }}" class="lg:ml-5 md:ml-5">
                        @csrf
                        @method('DELETE')
                  ...
                  <div class="p-2 w-full mt-4 flex justify-around">
                    <button type="button" onclick="location.href='{{ route('user.posts.index') }}'" class="bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-opacity-90 rounded-xl text-md shadow-md">一覧に戻る</button>
                  </div>
                </div>
              </div>
            </div>
