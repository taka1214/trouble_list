                ...
                <table class="table-auto w-full mb-5 text-left whitespace-no-wrap">
                  ...
                  <tbody>
                    ...
                    <tr class="{{ $bgColor }}">
                      ...
                      <td class="hidden sm:table-cell px-2 sm:px-4 py-3" onclick="location.href='{{ route('owner.posts.show', ['post' => $post->id]) }}'">{{ Str::limit($post->body, 80, '…' ) }}</td>
                      ...
                      <td class="px-2 sm:px-4 py-3 text-center md:block hidden">
                        <button onclick="location.href='{{ route('owner.posts.show', ['post' => $post->id]) }}'" class="text-white bg-default border-0 py-1 px-3 focus:outline-none hover:bg-opacity-90 rounded-xl text-md shadow-md">詳細</button>
                      </td>
