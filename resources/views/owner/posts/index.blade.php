                ...
                <table class="table-auto w-full text-left whitespace-no-wrap">
                  <thead>
                    <tr>
                      ...
                      <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">最終更新日</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="md:px-4 py-3">{{ $post->updated_at ? $post->updated_at->diffForHumans() : $post->created_at->diffForHumans() }}</td>
